defmodule Animina.ActivityLog.ActivityLogEntry do
  ...
  @events_by_category %{
    ...
    "profile" =>
      ~w(profile_updated flags_changed moodboard_changed preferences_changed location_changed avatar_changed email_changed password_changed passkey_registered passkey_deleted account_registered account_deleted account_reactivated),
    "admin" =>
    ...
    "system" =>
      ~w(photo_uploaded photo_approved photo_rejected photo_processing email_sent ollama_processed)
  }
