defmodule Animina.Checks.UpdateVisitLogEntryCheck do
  @moduledoc """
  ...
  def describe(_opts) do
    "Check a user cannot update a visit log entry for a bookmark they do not own"
  end

  def match?(actor, params, _opts) do
    if actor.id == get_owner_for_bookmark(params.changeset.data.bookmark_id) do
      true
    else
      false
    end
