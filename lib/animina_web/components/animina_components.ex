defmodule AniminaWeb.AniminaComponents do
  ...
  def notification_box(assigns) do
    ...
    <div
      class="border border-purple-400 md:w-[100%] w-[100%] mx-auto  rounded-lg bg-blue-100 px-4 py-3.5 flex items-start justify-between gap-10 drop-shadow xs:justify-start "
      phx-no-format
    >
  ...
  def footer(assigns) do
    ...
    <div class="px-6 pt-16 pb-8 mx-auto mt-4 border-t border-gray-900/10 dark:border-gray-200/10 ">
