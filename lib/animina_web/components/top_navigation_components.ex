defmodule AniminaWeb.TopNavigationCompontents do
  ...
  def desktop_sidebar(assigns) do
    ~H"""
    <div class="w-[15%] hidden md:flex h-[100vh]  flex-col gap-3 text-white border-r-[1px] border-gray-500">
      <div class="bg-red-500 p-2 flex gap-2 items-start w-[100%]">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          class="fill-current w-6 h-6 shrink-0"
          width="25"
      ...
      <div class="bg-red-500 p-2 w-[100%] flex flex-col gap-2">
        <div class="flex gap-2 items-start w-[100%]">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            class="fill-current w-6 h-6 shrink-0"
            width="25"
