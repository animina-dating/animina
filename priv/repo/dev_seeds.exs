...
defmodule Animina.Seeds.DevUsers do
  ...
  @male_users [
    %{name: "Thomas", email: "dev-thomas@animina.test", age: 32, roles: [:admin]},
    %{name: "Michael", email: "dev-michael@animina.test", age: 28, roles: [:moderator]},
    %{name: "Andreas", email: "dev-andreas@animina.test", age: 35, roles: [:admin, :moderator]},
    %{name: "Stefan", email: "dev-stefan@animina.test", age: 41, roles: []},
    %{name: "Christian", email: "dev-christian@animina.test", age: 29, roles: []},
    %{name: "Markus", email: "dev-markus@animina.test", age: 38, roles: [:admin]},
    %{name: "Daniel", email: "dev-daniel@animina.test", age: 26, roles: []},
    %{name: "Martin", email: "dev-martin@animina.test", age: 44, roles: []},
    %{name: "Sebastian", email: "dev-sebastian@animina.test", age: 31, roles: []},
    %{name: "Jan", email: "dev-jan@animina.test", age: 27, roles: []},
    %{name: "Tobias", email: "dev-tobias@animina.test", age: 33, roles: []},
    %{name: "Patrick", email: "dev-patrick@animina.test", age: 30, roles: []},
    %{name: "Felix", email: "dev-felix@animina.test", age: 25, roles: []},
    %{name: "Florian", email: "dev-florian@animina.test", age: 37, roles: []},
    %{name: "Matthias", email: "dev-matthias@animina.test", age: 42, roles: []},
    %{name: "Alexander", email: "dev-alexander@animina.test", age: 29, roles: []},
    %{name: "Philipp", email: "dev-philipp@animina.test", age: 34, roles: []},
    %{name: "Dominik", email: "dev-dominik@animina.test", age: 27, roles: []},
    %{name: "Marcel", email: "dev-marcel@animina.test", age: 40, roles: []},
    %{name: "Tim", email: "dev-tim@animina.test", age: 26, roles: []},
    %{name: "Lukas", email: "dev-lukas@animina.test", age: 31, roles: []},
  ...
  @female_users [
    %{name: "Julia", email: "dev-julia@animina.test", age: 30, roles: [:admin]},
    %{name: "Anna", email: "dev-anna@animina.test", age: 25, roles: [:moderator]},
    %{name: "Sarah", email: "dev-sarah@animina.test", age: 33, roles: [:admin, :moderator]},
    %{name: "Laura", email: "dev-laura@animina.test", age: 28, roles: [:moderator]},
    %{name: "Lisa", email: "dev-lisa@animina.test", age: 36, roles: []},
    %{name: "Maria", email: "dev-maria@animina.test", age: 42, roles: []},
    %{name: "Katharina", email: "dev-katharina@animina.test", age: 29, roles: []},
    %{name: "Sandra", email: "dev-sandra@animina.test", age: 34, roles: []},
    %{name: "Stefanie", email: "dev-stefanie@animina.test", age: 27, roles: []},
    %{name: "Christina", email: "dev-christina@animina.test", age: 39, roles: []},
    %{name: "Nicole", email: "dev-nicole@animina.test", age: 31, roles: []},
    %{name: "Melanie", email: "dev-melanie@animina.test", age: 26, roles: []},
    %{name: "Sabrina", email: "dev-sabrina@animina.test", age: 35, roles: []},
    %{name: "Jennifer", email: "dev-jennifer@animina.test", age: 29, roles: []},
    %{name: "Nadine", email: "dev-nadine@animina.test", age: 32, roles: []},
    %{name: "Vanessa", email: "dev-vanessa@animina.test", age: 27, roles: []},
    %{name: "Daniela", email: "dev-daniela@animina.test", age: 41, roles: []},
    %{name: "Claudia", email: "dev-claudia@animina.test", age: 38, roles: []},
    %{name: "Tanja", email: "dev-tanja@animina.test", age: 30, roles: []},
    %{name: "Susanne", email: "dev-susanne@animina.test", age: 44, roles: []},
    %{name: "Martina", email: "dev-martina@animina.test", age: 37, roles: []},
  ...
  defp create_user(user_data, gender, country_id, index) do
    ...
    case Accounts.register_user(attrs) do
      {:ok, user} ->
        ...
        IO.puts("  Created: #{user_data.name} (#{user_data.email})")
        {:ok, user}

      {:error, reason} ->
        IO.puts("  ERROR creating #{user_data.name}: #{inspect(reason)}")
        {:error, reason}
    end
  end
