defmodule Animina.Repo.Migrations.SeedHeadline do
  ...
  defp headlines do
    [
      ...
      %{subject: "My Monday", position: 33},
      %{subject: "My Tuesday", position: 34},
      %{subject: "My Wednesday", position: 35},
      %{subject: "My Thursday", position: 36},
      %{subject: "My Friday", position: 37},
      %{subject: "My Saturday", position: 38},
      %{subject: "My Sunday", position: 39},
